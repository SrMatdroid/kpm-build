...
// Offset para 'release' (segundo campo: sysname es el 1º, release el 2º)
#define UTS_RELEASE_OFFSET (__NEW_UTS_LEN + 1) * 1
// Offset para 'version' (cuarto campo: sysname, release, node, version)
